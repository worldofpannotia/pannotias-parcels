...
public class CompressedSandBlock extends Block {
    ...
    public CompressedSandBlock(int level) {
        super(FabricBlockSettings.of(Material.SOIL).strength(getHardness(level), getResistance(level)).sounds(BlockSoundGroup.SAND).requiresTool());
    }
}
